					...
					<div class="panel-body">
						...
						<!-- tab start -->
							<div class="tab_container">
								...
								<label class="tab-label" for="tab1"><span>Route List</span></label>

								<input class="tab-inp" id="tab2" type="radio" name="tabs">
								<label class="tab-label" for="tab2"><span>Add Route</span></label>
									...
									<table class="table table-striped" id="mydata">
									  ...
									  <tbody>
										<tr>
										  ...
										  <th scope="row">R-01</th>
										  <th scope="row">Boshonto</th>
										  <th scope="row">50</th>
										  <th scope="row">Mohammadpur</th>
										  <th scope="row">Volvo</th>
										  <th scope="row">DHK-0124578</th>
										  <th scope="row">MD. Harun</th>
										  <td>
										...
										<tr>
										  <th scope="row">01 Jan, 2018</th>
										  <th scope="row">R-02</th>
										  <th scope="row">Hemonto</th>
										  <th scope="row">40</th>
										  <th scope="row">Mirpur</th>
										  <th scope="row">Nissan</th>
										  <th scope="row">CHT-0124578</th>
										  <th scope="row">MD. Habib</th>
										  <td>
											<a href="#" data-toggle="modal" data-target="#edit"><i class="fa fa-edit"></i></a>
											<a href="#" data-toggle="modal" data-target="#confirm"><i class="fa fa-trash"></i></a>
										  </td>
												...
												<div class="form-tools-cover">
													<div class="input-group">
														<div class='input-group date' id='datetimepicker1'>
															<input type='text' class="form-control" placeholder="Add Route Date"/>
