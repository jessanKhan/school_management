<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="employee-list.aspx.cs" Inherits="employee_list" %>
							...
							<div class="row">
								...
								<div class="col-md-6">
									<div class="action-btn-cover btn-group pull-right">
										<a href="add-employee.html"><i class="fa fa-plus"></i></a>
									...
									<table class="table table-striped" id="mydata">
									  ...
									  <tbody>
										<tr>
										  ...
										  <td>10,000</td>
										  <td>
											<a href="employee-profile.html"><i class="fa fa-eye"></i></a>
											<a href="#" data-toggle="modal" data-target="#edit"><i class="fa fa-edit"></i></a>
