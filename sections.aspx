					...
					<div class="panel-body">
						...
						<!-- tab start -->
							<div class="tab_container">
								...
								<label class="tab-label" for="tab1"><span>Section List</span></label>

								<input class="tab-inp" id="tab2" type="radio" name="tabs">
								<label class="tab-label" for="tab2"><span>Add Section</span></label>
